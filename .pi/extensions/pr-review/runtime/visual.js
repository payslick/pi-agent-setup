import { formatLaneList, laneIcon, severityBadge, severityLabel } from "./summary.js";
...
function renderAgentArtifacts(artifacts) {
...
function countFindings(findings, severities) {
